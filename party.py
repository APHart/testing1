...
def most_and_least_common_type(treats):
    ...
    If there is a tie between types:
    ...
    If all types have the same count:
    *Needs some fixin'
    ...
    *Needs some fixin'
    ...
    #if most_type == least_type, check for other types and reassign least type.
    #if only one type, change message to say "bring something else"
